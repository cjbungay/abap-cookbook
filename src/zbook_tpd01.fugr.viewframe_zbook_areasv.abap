*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZBOOK_AREASV
*   generation date: 13.12.2012 at 22:52:42 by user EWULFF
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZBOOK_AREASV        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZBOOK_AREASV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZBOOK_AREASV_EXTRACT
TOTAL = ZBOOK_AREASV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZBOOK_AREASV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZBOOK_AREASV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZBOOK_AREASV_EXTRACT
TOTAL = ZBOOK_AREASV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZBOOK_AREASV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZBOOK_AREASV'
...
TOTAL = ZBOOK_AREASV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZBOOK_AREASV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZBOOK_AREASV-UPD_FLAG NE SPACE.
