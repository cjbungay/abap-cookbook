...
DATA gt_demo           TYPE STANDARD TABLE OF zbook_status_demo2.
FIELD-SYMBOLS <demo>   TYPE                   zbook_status_demo2.
DATA gv_name           TYPE c LENGTH 30 VALUE 'ZBOOK_STATUS_DEMO2'.
...
START-OF-SELECTION.
  ...
  <demo>-s01-status = 'OPEN'.
  <demo>-sttext     = 'Eröffnet'.
